...
private:
    ...
    void publishHealthStatus()
    {
        ...
        health_msg.component_name = "grid_slam";
        ...
        health_msg.cpu_usage = 40.0; // Placeholder
        health_msg.memory_usage = 50.0; // Placeholder
    ...
    rclcpp::TimerInterface::SharedPtr map_update_timer_;
